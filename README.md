...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  to knowledge SQL databases are relational databases as ooposed to non relational where data is not stored in tables

- [ ] Why do tables need a `primary key`?

  to link to foreign keys and keep track of the order of data

- [ ] What is the name given to a table column that references the primary key on another table.
 foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
a third table is required to link both foreign keys to their primary counterparts
